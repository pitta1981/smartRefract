...
@ActionID(
        category = "File",
        id = "it.vs30.myeditor.saveProjectAs"
)
@ActionRegistration(
        displayName = "#CTL_saveProjectAs"
)
@ActionReference(path = "Menu/File", position = 1475, separatorBefore = 1462, separatorAfter = 1487)
@Messages("CTL_saveProjectAs=Save project")
